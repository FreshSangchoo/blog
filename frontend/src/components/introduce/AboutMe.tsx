    ...
    <div className="about-me-container">
      <div className="introduce-me-container">
        ...
        <div className="profile-introduction">
          <div className="name-text">박영남 | Developer</div>
          <div className="about-me-description">
            ...
            만들어냅니다. <br />
            또한 새로운 기술이나 도구를 익히는 데 거부감이 없으며, 필요하다고
            판단되면 빠르게 학습하고 적용해 문제를 해결합니다.
            <br />
            React와 React Native를 중심으로 웹과 모바일 서비스 위주의 개발을
            해왔고, 프로젝트 전반에서 기획부터 배포, 운영까지의 과정을 모두
            경험했습니다. 현재는 IT 보안 부트캠프에서 보안 관련 프로젝트를 진행하며 관점을 넓히고 있습니다. <br />
            앞으로도 기술과 보안을 함께 이해하는 개발자로서 신뢰할 수
            있는 시스템을 만들고 싶습니다.
          </div>
        </div>
      </div>
